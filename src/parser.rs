...
pub fn parse_document(input: &str) -> Result<ConTeXtNode, nom::Err<nom::error::Error<Span>>> {
...
fn parse_context_style_args(input: Span) -> IResult<Span, (&str, Option<HashMap<String, String>>)> {
...
pub fn dummy_span() -> SourceSpan {
    SourceSpan { start: 0, end: 0 , start_col: 0, start_line: 0}
}
